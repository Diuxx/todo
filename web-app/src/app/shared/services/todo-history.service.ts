...
export class TodoHistoryService {
  ...
  public getAll(): Observable<TodoHistoryEntry[]> {
    return from(db.todoHistory.orderBy('completedAt').reverse().toArray());
  }
  ...
  public unDoneDaily(todoItemId: string): Observable<boolean> {
    ...
    return this.deleteDoneEntriesInRange(
      todoItemId,
   ...
   */
  private deleteDoneEntriesInRange(
    todoItemId: string,
    startISO: string,
    endISO: string
  ): Observable<boolean> {
